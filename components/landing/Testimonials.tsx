    ...
    <Box marginTop="40px" marginBottom="40px">
      <Container maxW={'7xl'} py={16} as={Stack} spacing={12}>
        <Stack spacing={0} align={'center'}>
          <Heading fontFamily={'heading'} color='white'>Our Clients Speak</Heading>
          <Text fontFamily={'heading'} color='white' marginTop="5px">Customers can't stop raving about their growth 🔥</Text>
        </Stack>
        <Stack
